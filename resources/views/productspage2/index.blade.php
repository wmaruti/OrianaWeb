...
@section('content')
    ...
    <div id="home" class="slider-area" style="background-color: white;">
        ...
        <div  class="image " style="width:1355px;">
                <img  src="{{ Storage::url('images/setting/pexels-expect-best-323780-copy.png') }}" alt="" title="" /> <br>
           ...
           <strong> <p> <h2 class="title1"  style="margin-top: -290px; margin-left: -900px; font-weight:bold;">for Education</h2></p> 
            <p><h2 class="title1"  style=" margin-left: -1030px; font-weight:bold;">Sector</h2></p> </strong>
            <!-- opera setting
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="layer-1-8 alignleft" >
                    <br> <br><br> <br><br> <br><br> <br><br> 
                    <!-- <br><br> <br><br> <br><br> <br><br> -->
                        <p><h2>Connect all parts of<h2></p><p> <h2>education stakeholders</h2></p>
                    </div>
                    <br> <br>
...
color: #4a4a4a;
                    ...
                    <h5 class="title1 gaya" >
                    Oriana for Education Industry is a platform<br>
                    system to connect all parts of education <br>
                    stakeholders like students, alumni, teachers, <br>
                    universities from local to global scope. <br>
                    <br>
                    
                    With such a huge opportunity to gather,  <br>
                    Oriana proved to assist our partner to build<br> 
                    one system with a great strong back-end to  <br>
                    handle more than 80.000 users to access <br>
                    simultaneously. The ultimate meaning of the<br>
                    connection is perfectly manifested.
                    </h5>
                    ...
                    <div >
                        <div >
                            <a href="#"  style="margin-left: 890px">
                                ...
                                <img src="{{ Storage::url('images/setting/group-6.png ') }}" alt="" title="" style="margin-right: 170px; margin-top: -330px; width: 39.25rem; "  >
                                @endif
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <!-- layer 1 -->
                                <div class="layer-1-8 hidden-xs wow  text-center " data-wow-duration="2s" data-wow-delay=".2s" >
                                    <h2 class="title1">Chat with our consultan</h2>
                                </div>
                ...
                <br>  <br>
                    ...
                    <div class="col-md-12 col-sm-6 col-xs-12">
                        <div class="form contact-form"  style="margin-left: 351px;">
                            ...
                            <form action="{{ route('contact.store3') }}" method="post" role="form" class="contactForm">
                                @csrf
                            ...
                            <input type="number" min="0" max="9999999999999999999999999999999999" name="phone"  value="{{ old('phone') }}" id="name" placeholder=" Phone*" data-rule="minlen:4" data-msg="Please enter at least 4 chars"  style="border: none; border-bottom: 1px solid #bababa; width:18.5rem; height:40px;"/>
                        </p>
                        ...
                        <div class="form contact-form"  style="margin-left: 51x;">
                            ...
                            {{ csrf_field() }}
                                ...
                                <p>
                                    ...
                                    <input class="form-control" type="number" min="0" max="9999999999999999999999999999999999" name="phone"   id="phone" placeholder=" Phone*" data-rule="minlen:4" data-msg="Please enter at least 4 chars"  style="border: none; border-bottom: 1px solid #bababa; width:18.4rem; margin-top:-49px; margin-left:215px;"/>
                                </p>
