...
class Productspage2Controller extends Controller
{
    public function index() {
        ...
        return view('productspage2/index', [
            'about'     => $about,
    ...
    public function contactStore3(Request $request) {
        ...
        return redirect(url('productspage2'));
    }
}
